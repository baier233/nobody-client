...
void StrayCache::Load1710ForgeMap() {
	{
		...
		minecraft_getRenderViewEntity = Java::GetInstance()->Env->GetMethodID(minecraft_class, "func_175606_aa", "()Lnet/minecraft/entity/Entity;"); // nullptr
		...
		minecraft_thePlayer = Java::GetInstance()->Env->GetFieldID(minecraft_class, "field_71439_g", "Lnet/minecraft/client/entity/EntityClientPlayerMP;");
		...
		minecraft_renderManager = Java::GetInstance()->Env->GetFieldID(minecraft_class, "field_175616_W", "Lnet/minecraft/client/renderer/entity/RenderManager;"); // nullptr
		...
		{
			minecraft_netManager = Java::GetInstance()->Env->GetFieldID(minecraft_class, "field_147302_e", "Lnet/minecraft/client/network/NetHandlerPlayClient;");
		...
		minecraft_objectMouseOver = Java::GetInstance()->Env->GetFieldID(minecraft_class, "field_71476_x", "Lnet/minecraft/util/MovingObjectPosition;");
...

	{
		...
		netHandlerPlayClient_getPlayerInfo = Java::GetInstance()->Env->GetMethodID(netHandlerPlayClient_class, "func_175102_a", "(Ljava/util/UUID;)Lnet/minecraft/client/network/NetworkPlayerInfo;"); //nullptr
		netHandlerPlayClient_addToSendQueue = Java::GetInstance()->Env->GetMethodID(netHandlerPlayClient_class, "func_147297_a", "(Lnet/minecraft/network/Packet;)V");
...

	{
		...
		guiIngame_getTabList = Java::GetInstance()->Env->GetMethodID(guiIngame_class, "func_175181_h", "()Lnet/minecraft/client/gui/GuiPlayerTabOverlay;"); //nullptr
	}


	{
		Java::GetInstance()->AssignClass("net.minecraft.client.gui.GuiPlayerTabOverlay", guiPlayerTabOverlay_class);
		guiPlayerTabOverlay_class = (jclass)Java::GetInstance()->Env->NewGlobalRef(guiPlayerTabOverlay_class); //nullptr
...

	{
		...
		entity_boundingBox = Java::GetInstance()->Env->GetFieldID(entity_class, "field_70121_D", "Lnet/minecraft/util/AxisAlignedBB;");
...

	{
		...
		entityPlayer_isBlocking = Java::GetInstance()->Env->GetMethodID(entityPlayer_class, "func_70632_aY", "()Z");
...

	{
		...
		entityPlayerSP_sendQueue = Java::GetInstance()->Env->GetFieldID(entityPlayerSP_class, "field_71174_a", "Lnet/minecraft/client/network/NetHandlerPlayClient;"); //nullptr
	}
...

	{
		...
		activeRenderInfo_VIEWPORT = Java::GetInstance()->Env->GetStaticFieldID(activeRenderInfo_class, "field_74597_i", "Ljava/nio/IntBuffer;");
		activeRenderInfo_PROJECTION = Java::GetInstance()->Env->GetStaticFieldID(activeRenderInfo_class, "field_74595_k", "Ljava/nio/FloatBuffer;");
		activeRenderInfo_MODELVIEW = Java::GetInstance()->Env->GetStaticFieldID(activeRenderInfo_class, "field_74594_j", "Ljava/nio/FloatBuffer;");
	}
...

	{
		...
		renderManager_Instance = Java::GetInstance()->Env->GetStaticFieldID(renderManager_class, "field_78727_a", "Lnet/minecraft/client/renderer/entity/RenderManager;");
...

	{
		...
		world_getBlock = Java::GetInstance()->Env->GetMethodID(world_class, "func_147439_a", "(III)Lnet/minecraft/block/Block;");
		world_rayTraceBlocks = Java::GetInstance()->Env->GetMethodID(StrayCache::GetInstance()->world_class, "func_147447_a", "(Lnet/minecraft/util/Vec3;Lnet/minecraft/util/Vec3;ZZZ)Lnet/minecraft/util/MovingObjectPosition;");
		world_getBlockState = Java::GetInstance()->Env->GetMethodID(StrayCache::GetInstance()->world_class, "func_180495_p", "(Lnet/minecraft/util/BlockPos;)Lnet/minecraft/block/state/IBlockState;"); //nullptr
		world_isAirBlock = Java::GetInstance()->Env->GetMethodID(StrayCache::GetInstance()->world_class, "func_147437_c", "(III)Z"); //nullptr
...

	{
		...
		chunk_getBlock = Java::GetInstance()->Env->GetMethodID(StrayCache::GetInstance()->chunk_class, "func_177438_a", "(III)Lnet/minecraft/block/Block;"); //nullptr
	}
...

	{
		...
		timer_timerSpeed = Java::GetInstance()->Env->GetFieldID(StrayCache::GetInstance()->timer_class, "field_74278_d", "F");
		timer_renderPartialTicks = Java::GetInstance()->Env->GetFieldID(StrayCache::GetInstance()->timer_class, "field_74281_c", "F");

	}


	{
		Java::GetInstance()->AssignClass("net.minecraft.util.AxisAlignedBB", axisAlignedBB_class);
	...
	{
		Java::GetInstance()->AssignClass("net.minecraft.util.MovingObjectPosition", movingObjectPosition_class);
		movingObjectPosition_class = (jclass)Java::GetInstance()->Env->NewGlobalRef(movingObjectPosition_class);

		movingObjectPosition_blockX = Java::GetInstance()->Env->GetFieldID(movingObjectPosition_class, "field_72311_b", "I");
		movingObjectPosition_blockY = Java::GetInstance()->Env->GetFieldID(movingObjectPosition_class, "field_72312_c", "I");
		movingObjectPosition_blockZ = Java::GetInstance()->Env->GetFieldID(movingObjectPosition_class, "field_72309_d", "I");
		movingObjectPosition_hitVec = Java::GetInstance()->Env->GetFieldID(movingObjectPosition_class, "field_72307_f", "Lnet/minecraft/util/Vec3;");
		movingObjectPosition_typeOfHit = Java::GetInstance()->Env->GetFieldID(movingObjectPosition_class, "field_72313_a", "Lnet/minecraft/util/MovingObjectPosition$MovingObjectType;");
		movingObjectPosition_blockPos = Java::GetInstance()->Env->GetFieldID(movingObjectPosition_class, "field_178783_e", "Lnet/minecraft/util/BlockPos;");
	}

	{
		Java::GetInstance()->AssignClass("net.minecraft.util.Vec3", vec3_class);
...

	{
		...
		inventoryPlayer_mainInv = Java::GetInstance()->Env->GetFieldID(inventoryPlayer_class, "field_70462_a", "[Lnet/minecraft/item/ItemStack;");
		inventoryPlayer_armorInv = Java::GetInstance()->Env->GetFieldID(inventoryPlayer_class, "field_70460_b", "[Lnet/minecraft/item/ItemStack;");
...

	{
		...
		itemStack_getStrVsBlock = Java::GetInstance()->Env->GetMethodID(itemStack_class, "func_150997_a", "(Lnet/minecraft/block/Block;)F");
	}
...

	{
		...
		item_getIdFromItem = Java::GetInstance()->Env->GetMethodID(item_class, "func_150891_b", "(Lnet/minecraft/item/Item;)I");//nullptr
	}
	...
	/*{
		Java::GetInstance()->AssignClass("net.minecraft.util.BlockPos", blockPos_class);
	...
	/*{
		Java::GetInstance()->AssignClass("net.minecraft.block.state.BlockState", blockState_class);
