...
void StrayCache::Load1181ForgeMap() {
	...
	{
		Java::AssignClass("net.minecraft.world.phys.BlockHitResult", blockHitResult_class);
		blockHitResult_class = (jclass)Java::Env->NewGlobalRef(blockHitResult_class);
		blockHitResult_blockPos = Java::Env->GetFieldID(blockHitResult_class, "f_82411_", "Lnet/minecraft/core/BlockPos;");
		blockHitResult_miss = Java::Env->GetFieldID(blockHitResult_class, "f_82412_", "Z");
	}
