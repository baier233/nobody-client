...
void StrayCache::Load189MCPMap() {
	{
		...
		minecraft_getNetHandler = Java::GetInstance()->Env->GetMethodID(minecraft_class, "getNetHandler", "()Lnet/minecraft/client/network/NetHandlerPlayClient;");
		...
		minecraft_thePlayer = Java::GetInstance()->Env->GetFieldID(minecraft_class, "thePlayer", "Lnet/minecraft/client/entity/EntityPlayerSP;");
		minecraft_theWorld = Java::GetInstance()->Env->GetFieldID(minecraft_class, "theWorld", "Lnet/minecraft/client/multiplayer/WorldClient;");
		...
		minecraft_objectMouseOver = Java::GetInstance()->Env->GetFieldID(minecraft_class, "objectMouseOver", "Lnet/minecraft/util/MovingObjectPosition;");
...

	{
		...
		networkManager_sendPacket = Java::GetInstance()->Env->GetMethodID(networkManager_class, "sendPacket", "(Lnet/minecraft/network/Packet;Lio/netty/util/concurrent/GenericFutureListener;[Lio/netty/util/concurrent/GenericFutureListener;)V");
...

	{
		...
		entity_inWater = Java::GetInstance()->Env->GetMethodID(entity_class, "inWater", "()Z");
		...
		entity_boundingBox = Java::GetInstance()->Env->GetFieldID(entity_class, "boundingBox", "Lnet/minecraft/util/AxisAlignedBB;");
		...
		entity_ticksExisted = Java::GetInstance()->Env->GetFieldID(entity_class, "ticksExisted", "F");
...

	{
		...
		playerControllerMP_sendUseItem = Java::GetInstance()->Env->GetMethodID(playerControllerMP_class, "sendUseItem", "(Lnet/minecraft/entity/player/EntityPlayer;Lnet/minecraft/world/World;Lnet/minecraft/item/ItemStack;)Z");
	}

	{
		...
		entityLivingBase_moveForward = Java::GetInstance()->Env->GetFieldID(entityLivingBase_class, "moveForward", "I");
		entityLivingBase_moveStrafe = Java::GetInstance()->Env->GetFieldID(entityLivingBase_class, "moveStrafing", "I");
		entityLivingBase_swingItem = Java::GetInstance()->Env->GetMethodID(entityLivingBase_class, "swingItem", "()V");
...

	{
		...
		entityPlayer_isBlocking = Java::GetInstance()->Env->GetMethodID(entityPlayer_class, "isBlocking", "()Z");
...

	{
		...
		world_rayTraceBlocks = Java::GetInstance()->Env->GetMethodID(StrayCache::GetInstance()->world_class, "rayTraceBlocks", "(Lnet/minecraft/util/Vec3;Lnet/minecraft/util/Vec3;ZZZ)Lnet/minecraft/util/MovingObjectPosition;");
		world_getChunkFromChunkCoords = Java::GetInstance()->Env->GetMethodID(StrayCache::GetInstance()->world_class, "getChunkFromChunkCoords", "(II)Lnet/minecraft/world/chunk/Chunk;");
		world_getBlockState = Java::GetInstance()->Env->GetMethodID(StrayCache::GetInstance()->world_class, "getBlockState", "(Lnet/minecraft/util/BlockPos;)Lnet/minecraft/block/state/IBlockState;");
		world_isAirBlock = Java::GetInstance()->Env->GetMethodID(StrayCache::GetInstance()->world_class, "isAirBlock", "(Lnet/minecraft/util/BlockPos;)Z");
...

	{
		...
		timer_timerSpeed = Java::GetInstance()->Env->GetFieldID(StrayCache::GetInstance()->timer_class, "timerSpeed", "F");
...

	{
		...
		movingObjectPosition_hitVec = Java::GetInstance()->Env->GetFieldID(movingObjectPosition_class, "hitVec", "Lnet/minecraft/util/Vec3;");
		movingObjectPosition_typeOfHit = Java::GetInstance()->Env->GetFieldID(movingObjectPosition_class, "typeOfHit", "Lnet/minecraft/util/MovingObjectPosition$MovingObjectType;");
		movingObjectPosition_blockPos = Java::GetInstance()->Env->GetFieldID(movingObjectPosition_class, "blockPos", "Lnet/minecraft/util/BlockPos;");
	}
...

	{
		...
		inventoryPlayer_mainInv = Java::GetInstance()->Env->GetFieldID(inventoryPlayer_class, "mainInventory", "[Lnet/minecraft/item/ItemStack;");
		inventoryPlayer_armorInv = Java::GetInstance()->Env->GetFieldID(inventoryPlayer_class, "armorInventory", "[Lnet/minecraft/item/ItemStack;");
...

	{
		...
		itemStack_getStrVsBlock = Java::GetInstance()->Env->GetMethodID(itemStack_class, "getStrVsBlock", "(Lnet/minecraft/block/Block;)F");
	}
	{
		...
		item_getIdFromItem = Java::GetInstance()->Env->GetMethodID(item_class, "getIdFromItem", "(Lnet/minecraft/item/Item;)I");
	}
...

	{
		...
		itemTool_getStrVsBlock = Java::GetInstance()->Env->GetMethodID(itemTool_class, "getStrVsBlock", "(Lnet/minecraft/item/ItemStack;Lnet/minecraft/block/Block;)F");
	}
